...
def run_pipeline(args, root_path):
    ...
    if (not has_img_metadata) | args.query_images:
        ...
        logging.info("Configured to not query new image metadata. Skip image metadata download.")
    ...
    if args.query_images:
        ...
        logging.info("Only use existing image classifications. Skip classification step.")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--recreate_roads", action=argparse.BooleanOptionalAction, default=False)
    parser.add_argument("--query_images", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--export_results", action=argparse.BooleanOptionalAction, default=True)
