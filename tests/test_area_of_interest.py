...
def aoi():
    ...
    return AreaOfInterest(dict(name="test_aoi", data_root="/path/to/data", 
                               run="run1", 
                               minLon=10, minLat=15, maxLon=20, maxLat=25, proj_crs=3035,
                               img_size="thumb_2048_url", dist_from_road=10,
                               min_road_length=10, segment_length=20, segments_per_group=10,
                               pred_path="pred_path", road_type_pred_path="road_type_pred_path"))
